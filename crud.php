    ...
    <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex-1 md:flex md:items-center md:gap-12">
          ...
          <span class="self-center text-2xl font-semibold whitespace-nowrap text-slate-300 cursor-pointer">crud</i></span> <!-- Teks disamping logo -->
        </div>
        ...
        <div class="flex-1 md:flex md:items-center md:gap-12 justify-center">
          <nav aria-label="Global">
            <ul class="flex items-center gap-6 text-sm">
              ...
              <li>
                <a class="block  text-indigo-600	font-medium font-semibold transition hover:text-gray-500/75 <?php if ($currentPage == 'Judul') echo 'active'; ?>" href="#"> crud </a>
              </li>
            </ul>
          </nav>
        </div>
